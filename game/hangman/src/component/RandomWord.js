...
export default function RandomWord({ onSet, isShown }) {
  ...
  let Words = [
    ...
    },
    {
      ...
      cate: 'fruits',
      exam: [
        'apple', 'orange', 'banana', 'melon', 'peach', 'watermelon', 'kiwi', 'tomato', 'grape', 'mango', 'papaya', 'coconut', 'pineapple', 'cherry', 'yuja', 'Mandarin', 'lime', 'blueberry', 'plum', 'avocado', 'pear', 'strawberry', 'guaba', 'chestnut', 'fig', 'pomegranate', 'quince', 'jujube', 'msoffice', 'hwp', 'excel', 'word', 'powerpoint', 'keyword', 'keyboard', 'headset', 'userInterface', 'logitech mx master 3s'
      ]
    },
    {
      id: 3,
