  ...
  let Words = [
    {
      ...
      cate: 'sports',
      exam: [
        'soccer', 'baseball', 'basketball', 'frisbee', 'hockey', 'volleyball', 'skating', 'frisbee', 'flowball', 'football', 'crosscountry', 'kinball', 'swimming', 'climing', 'e-sports', 'kayaking', 'pingpong', 'shorttrack', 'stacking', 'vicpie', 'handphone', 'smartphone', 'ttazza', 'hannibal', 'hangeul', 'standard', 'kiho', 'gijun', 'gwangyoung', 'jisoo', 'gunyoung', 'dongbin', 'bosung', 'sejoon'
      ]
    },
    {
      id: 2,
    ...
    },
    {
      ...
      cate: 'champions',
      exam: [
        'Gragas', 'Thresh', 'Hecarim', 'Catelin', 'Morgana', 'vex', 'ezreal', 'Garen', 'Casadin', 'Zinx', 'Galio'
      ]
    }
  ]
