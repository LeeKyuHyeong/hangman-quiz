  ...
  let Words = [
    {
      ...
      cate: 'sports',
      exam: [
        'soccer', 'baseball', 'basketball', 'frisbee', 'hockey', 'volleyball', 'skating', 'frisbee', 'flowball', 'football', 'crosscountry'
      ]
    },
    {
      id: 2,
    ...
    },
    {
      ...
      cate: 'countries',
      exam: [
        'Korea', 'England', 'China', 'Swiss', 'Mexico', 'Brazil', 'Japan', 'America', 'Russia', 'Mongole', 'Greece', 'UAE'
      ]
    }
  ]
