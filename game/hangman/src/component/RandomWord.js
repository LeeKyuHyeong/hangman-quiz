  ...
  let Words = [
    {
      ...
      cate: 'sports',
      exam: [
        'soccer', 'baseball', 'basketball', 'frisbee', 'hockey', 'volleyball', 'skating', 'frisbee'
      ]
    },
    {
      id: 2,
      cate: 'fruits',
      exam: [
        'apple', 'orange', 'banana', 'melon', 'peach', 'watermelon', 'kiwi', 'tomato'
      ]
    },
    {
      id: 3,
      cate: 'countries',
      exam: [
        'Korea', 'England', 'China', 'Swiss', 'Mexico', 'Brazil', 'Japan', 'America'
      ]
    }
  ]
